  ...
  return (
    <div className="flex items-center gap-5 mb-3">
        ...
        <div className="flex items-center justify-between w-full">
            ...
            <div>
                <h1 className="text-[#f6b100] font-semibold border border-[#f6b100] rounded-lg p-1">Mesa Nro: 3</h1>
            </div>
            <div className="flex flex-col items-start gap-2">
                <p className="text-green-600 px-4"><FaCheckDouble className="inline mr-2"/> Listo</p>
