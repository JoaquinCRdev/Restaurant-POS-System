...
const BottomNav = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
      <button className="flex items-center justify-center text-[#f5f5f5] bg-[#343434] w-50 rounded-[20px] cursor-pointer">
        <FaHome className="inline mr-2" size={30} /> <p>Inicio</p>
      </button>
      <button className="flex items-center justify-center text-[#ababab] w-50 cursor-pointer">
